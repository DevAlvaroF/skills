---
name: alvaro-setup-matt-pocock-skills
...
> Explainer: The "issue tracker" is where issues live for this repo. Skills like `alvaro-matt-to-tickets`, `alvaro-matt-triage`, and `alvaro-matt-to-spec` read from and write to it. They need to know whether to call `gh issue create`, write a markdown file under `.scratch/`, or follow some other workflow you describe. Pick the place you actually track work for this repo.
...
- The contents of `agents-docs/issue-tracker.md`, `agents-docs/project-docs.md`, and `agents-docs/triage-labels.md` (the last only when `alvaro-matt-triage` is installed)
...
Include the `### Triage labels` sub-block, and write `agents-docs/triage-labels.md`, only when `alvaro-matt-triage` is installed and Section B ran. When it isn't, both are omitted.
...
- [triage-labels.md](./triage-labels.md): label mapping (only if `alvaro-matt-triage` is installed)
