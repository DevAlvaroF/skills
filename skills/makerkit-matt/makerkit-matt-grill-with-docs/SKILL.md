---
name: makerkit-matt-grill-with-docs
...
**Before the first round**, call the Skill tool with "makerkit-matt-domain-modeling" and run it alongside this interview: it challenges the terms as they come up and records vocabulary and decisions into the owning `AGENTS.md` the moment they crystallise, rather than at the end.
