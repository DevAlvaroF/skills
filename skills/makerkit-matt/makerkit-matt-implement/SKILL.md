...
1. **Review the work** — two-axis review of the diff, detailed below.
2. `pnpm typecheck`
3. `pnpm lint:fix`
4. `pnpm format:fix`
5. /reviewer
...
Both axes run as **parallel sub-agents** so they don't pollute each other's context, then this step aggregates their
findings.
